...
public class TestJomkie {
    ...
    public static void main(String[] args) {
        ...
        Function<TestJoUser, String> acquireParentIdentifierFunction = TestJoUser::getParentId;
        ...
        TreeTool<TestJoUser, String> treeTool = new TreeTool<>(acquireParentIdentifierFunction, acquireChildsByParentIdentifierFunction, setChildFunction);
        treeTool.getTree(2, rootList);
